        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-gray-400 mb-10 max-w-lg mx-auto lg:mx-0">
              ...
              applications with stunning user interfaces and flawless functionality.
              I also bring expertise in backend systems and cloud infrastructure to ensure
            ...
            <div className="mt-12 flex flex-wrap justify-center lg:justify-start gap-3">
              {["React", "Next.js", "React Native", "Tailwind CSS", "Node.js", "AWS", "Docker"].map(
                (tech) => (
                  <motion.div
                    key={tech}
                    whileHover={{ y: -3 }}
